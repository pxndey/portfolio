    ...
    },
    {
      ...
      "metrics": [
        ...
        },
        {
          "icon": "layers",
          "value": "SLAM",
          "label": "assignment designed"
        },
        {
          "icon": "cloud",
          "value": "HPC",
          "label": "SLURM + cloud support"
        }
      ],
      "responsibilities": [
    ...
    },
    {
      ...
      "extracurriculars": [
        ...
        },
        {
          ...
          "details": [
            "Organised student teams that sparked inquisitiveness about core science concepts in high schoolers at Williams Matriculation and Aatichuty Special School in Vellore.",
      ...
      "metrics": [
        {
          "icon": "hard-drive",
          "value": "32TB",
          "label": "raw HDD storage"
        },
        {
          "icon": "database",
          "value": "ZFS",
          "label": "snapshots + self-healing"
        },
        {
          "icon": "clock",
          "value": "Nightly",
          "label": "verified restic backups"
        }
      ],
      "description": [
      ...
      "metrics": [
        {
          "icon": "cpu",
          "value": "24",
          "label": "transformers trained"
        },
        {
          "icon": "trending-up",
          "value": "1.93",
          "label": "best test perplexity"
        },
        {
          "icon": "check-circle",
          "value": "100%",
          "label": "valid SVG generations"
        }
      ],
      "description": [
      ...
      "metrics": [
        {
          "icon": "activity",
          "value": "66K",
          "label": "clean laps analyzed"
        },
        {
          "icon": "flag",
          "value": "25",
          "label": "circuits compared"
        },
        {
          "icon": "trending-up",
          "value": "2,644",
          "label": "stint degradation rates"
        }
      ],
      "description": [
      ...
      "metrics": [
        {
          "icon": "grid",
          "value": "224K",
          "label": "molecules assigned"
        },
        {
          "icon": "layers",
          "value": "6",
          "label": "imaging rounds"
        }
      ],
      "description": [
      ...
      "metrics": [
        {
          "icon": "activity",
          "value": "0.617",
          "label": "private-leaderboard score"
        },
        {
          "icon": "trending-up",
          "value": "+0.10",
          "label": "MS-SSIM from pretraining"
        },
        {
          "icon": "cpu",
          "value": "60K",
          "label": "synthetic slice pairs"
        }
      ],
      "description": [
      ...
      "metrics": [
        {
          "icon": "video",
          "value": "6,000",
          "label": "pitch videos classified"
        },
        {
          "icon": "cpu",
          "value": "170×",
          "label": "smaller rebuilt model"
        }
      ],
      "description": [
      ...
      "metrics": [
        {
          "icon": "grid",
          "value": "209",
          "label": "histology slides"
        },
        {
          "icon": "layers",
          "value": "20",
          "label": "models ensembled"
        }
      ],
      "description": [
